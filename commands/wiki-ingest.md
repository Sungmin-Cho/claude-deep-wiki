...
| Ingest-fail 3-strike abort (Step 7.5.M-D) | `ingest-fail` | ❌ omitted (Step 7.5.M-D emits its own line) | n/a | n/a | n/a |
...
if sources_count == 1:
    ...
    F1_DRIFT_DETECTED=false   # F1.1 fix — track drift to force A5 fanout
